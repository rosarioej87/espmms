...
{{--                                 @include('voyager::action-plans.relationship', ['view' => 'read', 'options' => $row->details])--}}
...
@section('content')
    <iframe src="/reports/monitoring-pdf" height="1000" width="100%" title="Iframe Example" style="border:none;"></iframe>
@endsection
