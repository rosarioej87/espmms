        ...
        @elseif($options->type == 'hasMany')
            ...
            @if(isset($view) && ($view == 'browse' || $view == 'read'))
                ...
                @php
                    ...
                    $datasets = $model::where($options->column, '=', $dataTypeContent->{$options->key})->get();
                @endphp
                    ...
                    @else
                        <ul>
                            @foreach($datasets as $dataset)
                                <li><a href="{{ route('voyager.programs.show', $dataset->{$options->key}) }}" target="_blank">{{ $dataset->{$options->label} }}</a></li>
                            @endforeach
                        </ul>
                    @endif
                @endif
