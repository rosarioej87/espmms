    ...
    ManageThemeBackground: function () {
      ...
      function setlogobg() {
        ...
        if (lbg != undefined && lbg != "") {
          $("#" + myid + " .topbar .top-navbar .navbar-header").attr(
            "data-logobg",
            lbg
          );
        } else {
      ...
      function setnavbarbg() {
        ...
        if (nbg != undefined && nbg != "") {
          $("#" + myid + " .topbar .navbar-collapse").attr(
            "data-navbarbg",
            nbg
          );
...
$(function () {
  ...
  $(document).on(
    "click",
    ".chat-windows .user-chat .chat-head .closeit",
    function (e) {
      var id = $(this).attr("data-user-id");
      $(".chat-windows #user-chat" + id).hide();
      $("#chat .message-center .user-info#chat_user_" + id).removeClass(
        "active"
      );
    }
  );
  ...
  $(document).on(
    "keypress",
    ".chat-windows .user-chat .chat-footer input",
    function (e) {
      if (e.keyCode == 13) {
        var id = $(this).attr("data-user-id");
        var msg = $(this).val();
        msg = msg_sent(msg);
        $(".chat-windows #user-chat" + id + " .chat-body .chat-list").append(
          msg
        );
        $(this).val("");
        $(this).focus();
  ...
  $(".service-frontend-toggle").on("click", function (e) {
